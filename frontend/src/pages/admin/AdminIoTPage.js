                      ...
                      <td colSpan="6" className="p-4">
                        <div className="grid grid-cols-5 gap-4">
                          {[
                            ...
                            { label: 'IR Status', val: farm.last_reading?.ir_status == null || farm.last_reading?.ir_status === 'disconnected' ? 'N/A' : farm.last_reading?.ir_status === 'detected' ? 'Detected' : 'Clear', unit: '', icon: <Eye size={14} />, color: farm.last_reading?.ir_status == null || farm.last_reading?.ir_status === 'disconnected' ? 'text-gray-400' : farm.last_reading?.ir_status === 'detected' ? 'text-red-600' : 'text-green-600' },
                            { label: 'Sound', val: farm.last_reading?.sound_status == null || farm.last_reading?.sound_status === 'disconnected' ? 'N/A' : farm.last_reading?.sound_status === 'detected' ? 'Detected' : 'Silent', unit: '', icon: <Volume2 size={14} />, color: farm.last_reading?.sound_status == null || farm.last_reading?.sound_status === 'disconnected' ? 'text-gray-400' : farm.last_reading?.sound_status === 'detected' ? 'text-amber-600' : 'text-gray-500' },
                          ].map(s => (
