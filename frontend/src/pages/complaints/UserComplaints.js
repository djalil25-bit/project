    ...
    switch (user?.role) {
      ...
      case 'transporter':
        return {
          primary: 'text-[#10B981]',
          bgPrimary: 'bg-[#10B981]',
          hoverPrimary: 'hover:bg-[#059669]',
          bgSoft: 'bg-[#10B981]/10',
          borderSoft: 'border-[#10B981]/20',
          shadowPrimary: 'shadow-[0_10px_30px_rgba(16,185,129,0.3)]',
          hubText: 'Fleet Hub',
              ...
              <div key={c.id} className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-0.5">
                <div className="flex flex-col md:flex-row justify-between items-start gap-4">
                  <div className="flex items-start gap-4 flex-1">
                    <div className={`w-10 h-10 bg-slate-50 rounded-xl border border-slate-200 flex items-center justify-center shrink-0 ${theme.primary}`}>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-3 text-[10px] font-black tracking-widest uppercase text-slate-400">
                        ...
                        {c.order && (
                          <span className={`px-3 py-1.5 rounded-lg border flex items-center gap-1.5 ${theme.primary} ${theme.bgSoft} ${theme.borderSoft}`}>
                ...
                {c.admin_notes && (
                  <div className="mt-4 pt-4 border-t border-slate-100">
                    <div className={`border rounded-xl p-4 flex gap-3 ${theme.bgSoft} ${theme.borderSoft}`}>
                      <Info size={16} className={`${theme.primary} shrink-0 mt-0.5`} strokeWidth={2.5} />
                      <div>
                        <div className={`text-[9px] font-black uppercase tracking-widest mb-1 ${theme.primary}`}>Admin Response</div>
