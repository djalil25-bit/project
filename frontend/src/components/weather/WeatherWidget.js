...
const OWM_MAP = {
  ...
  '09d': { emoji: '🌧️', label: 'Shower Rain', bg: 'from-blue-500 to-blue-700', text: 'text-emerald-50' },
  '09n': { emoji: '🌧️', label: 'Shower Rain', bg: 'from-blue-700 to-slate-800', text: 'text-emerald-50' },
  '10d': { emoji: '🌦️', label: 'Rain', bg: 'from-blue-400 to-blue-600', text: 'text-emerald-50' },
  '10n': { emoji: '🌧️', label: 'Rain', bg: 'from-blue-700 to-indigo-900', text: 'text-emerald-100' },
