...
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', '127.0.0.1,localhost,192.168.1.104').split(',')
...
# Email Configuration
# Use console backend in DEBUG unless SMTP credentials are provided
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'AgriGov Market <no-reply@agrigov.com>')
